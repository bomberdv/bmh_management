...
//	),
    ...
    'menu' => array(
        ...
        'reimbursement' => array(
            'name'		=> $CI->lang->line('reimbursement'),
            'url'		=> 'mail',
            'icon'		=> 'crop_3_2',
            'children'  => array(
                $CI->lang->line('reimbursement_list')					=> 'employee/reimbursement',
                $CI->lang->line('approval')	    => 'employee/reimbursement/approval',
        ...
        'attendance' => array(
            'name'		=> $CI->lang->line('attendance'),
            'url'		=> 'employee/home/attendance',
            'icon'		=> 'border_clear',
        ),
