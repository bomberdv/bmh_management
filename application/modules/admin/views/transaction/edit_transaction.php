                    ...
                    <div class="col-md-12">
                       ...
                       <?php echo form_open('admin/transaction/update_transaction', array('class' => 'form-horizontal')) ?>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control input-lg" value="<?php echo $transaction->transaction_id ?>" disabled type="text">
                                </div>
                            </div>
                            ...
                            <?php if(empty($transaction_from)){ ?>
                                ...
                                <?php if($transaction->account_id != 2 && $transaction->account_id != 4 ){ ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <input class="form-control input-lg" value="<?php echo $transaction->account_title ?>" disabled type="text">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="val-password"><?= lang('transaction_type') ?></label>
                                        <div class="col-md-7">
                                            <input class="form-control input-lg" value="<?php echo $transaction->transaction_type ?>" disabled  type="text">
                                        </div>
                                    </div>
                                <?php }else{ ?>
                                    <!-- A/P, A/R -->
                            ...
                            <!--  transaction between two account-->
                                <div class="form-group">
                                    ...
                                    <div class="col-md-7">
                                        <input class="form-control input-lg" value="<?php echo $transaction_from->account_title ?>" disabled type="text">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control input-lg" value="<?php echo $transaction->category_name ?>" disabled  type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label"><?= lang('amount') ?></label>
                                <div class="col-md-7">
                                    <input class="form-control input-lg" value="<?php echo $transaction->amount ?>" disabled  type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control input-lg" value="<?php echo $transaction->balance ?>" disabled  type="text">
                                </div>
                            </div>
                            <?php if($transaction->account_id != 2 && $transaction->account_id != 4 ){ ?>
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control input-lg" value="<?php echo $transaction->payment_method ?>" disabled  type="text">
                                </div>
                            </div>
                            <?php } ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control input-lg" value="<?php echo $transaction->description ?>" name="description"  type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label"><?= lang('ref') ?>#</label>
                                <div class="col-md-7">
                                    <input class="form-control input-lg" value="<?php echo $transaction->ref ?>"  name="ref" type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-8 col-md-offset-3">
                                    <button class="btn btn-primary" type="submit" value="Submit"><i class="fa fa-save"></i> <?= lang('update_transaction') ?></button>
                                </div>
                            </div>
                    <?php echo form_close() ?>
                    </div>
