                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mailbox-controls pull-right">
                                <!-- Check all button -->
                                <a data-target="#modalSmall" title="View" data-placement="top" data-toggle="modal" href="<?php echo base_url('admin/transaction/add_account') ?>" class="btn bg-green-active"><i class="fa fa-plus" aria-hidden="true"></i> <?= lang('new_account') ?></a>
                            </div>
