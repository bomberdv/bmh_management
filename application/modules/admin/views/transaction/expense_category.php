                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mailbox-controls pull-right">
                                    <!-- Check all button -->
                                    <a data-target="#modalSmall" title="View" data-placement="top" data-toggle="modal" href="<?php echo base_url('admin/transaction/add_expense_category') ?>" class="btn bg-green-active"><i class="fa fa-plus" aria-hidden="true"></i> <?= lang('add').' '.lang('expense_categories') ?></a>
                                </div>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a data-target="#modalSmall" title="View" data-placement="top" data-toggle="modal"
                                               class="btn btn-xs btn-default" href="<?php echo base_url()?>admin/transaction/add_expense_category/<?php echo $item->id?>">
