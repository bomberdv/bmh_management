    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border bg-primary-dark">
                <h3 class="box-title"><?= lang('title_list') ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mailbox-controls pull-right">
                                    <!-- Check all button -->
                                    <a class="btn bg-green-active" onclick="add()"><i class="fa fa-fw fa-plus"></i><?= lang('add_job_title') ?></a>
                                </div>
...
<script>
    ...
    var table;
    var list        = 'admin/office/title_list';
    var saveRow     = 'admin/office/title_add';
    var edit        = 'admin/office/title_update';
    var deleteRow   = 'admin/office/title_delete/';
    ...
    function edit_title(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/office/title_edit/')?>/" + id,
            type: "GET",
