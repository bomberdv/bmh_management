    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border bg-primary-dark">
                <h3 class="box-title"><?= lang('list_leave_type') ?></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mailbox-controls pull-right">
                                    <!-- Check all button -->
                                    <a class="btn bg-green-active" onclick="add()"><i class="fa fa-fw fa-plus"></i><?= lang('add_leave_type') ?></a>
                                </div>
...
<script>
    ...
    var table;
    var list        = 'admin/office/leaveType_list';
    var saveRow     = 'admin/office/add_leave_category';
    var edit        = 'admin/office/update_leave_category';
    var deleteRow   = 'admin/office/delete_leave_category/';
    ...
    function edit_title(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin/office/edit_leave_category/')?>/" + id,
            type: "GET",
