...
<!--                --><?php //echo form_open_multipart('admin/product/save_product')?>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-9 col-sm-12 col-xs-12 col-md-push-1">
                            <div id="msg"></div>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" value="<?php if(!empty($product->name))echo $product->name ?>" class="form-control input-lg">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group form-group-bottom">
                                                ...
                                                <input type="text" name="sku" class="form-control input-lg" value="<?php if(!empty($product->sku))echo $product->sku ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control input-lg select2" name="category_id" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sales_cost" class="form-control input-lg" value="<?php if(!empty($product->sales_cost))echo $product->sales_cost ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control input-lg" name="sales_info"><?php if(!empty($product->sales_info))echo $product->sales_info ?></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="buying_cost" class="form-control input-lg" value="<?php if(!empty($product->buying_cost))echo $product->buying_cost ?>">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control input-lg" name="buying_info"><?php if(!empty($product->buying_info))echo $product->buying_info ?></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control input-lg select2" name="tax_id">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="inventory" class="form-control input-lg" value="<?php if(!empty($product->inventory))echo $product->inventory ?>">
                            </div>
...
<!--                                                <option value"">Select Product</option>-->
                            ...
                            <a href="javascript::" class="btn btn-primary" onclick="save_product()" ><i class="fa fa-save"></i> <?= lang('save').' '.lang('product') ?></a>
