                                    ...
                                    <div class="form-group margin">
                                        ...
                                        <div class="col-sm-3" style="padding-top: 5px">
                                            <select class="form-control" name="status">
                                                <option value="pending" <?php echo $application->status == 'Pending' ? 'selected':''  ?>><?= lang('pending') ?></option>
                                                <option value="Accepted" <?php echo $application->status == 'Accepted' ? 'selected':''  ?>><?= lang('approved') ?></option>
                                                <option value="Rejected" <?php echo $application->status == 'Rejected' ? 'selected':''  ?>><?= lang('reject') ?></option>
                                            </select>
                                        </div>
                                    </div>
