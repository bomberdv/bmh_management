        ...
        <div class="row">
            <div class="col-md-12">
                <div class="well well-lg">
                    <h4><?= lang('salary_type') ?></h4> <br>
                    <input type="radio" name="type" value="Monthly" <?php if(!empty($empSalary)) echo $empSalary->type == 'Monthly'?'checked':'checked'?> onclick="show_monthly();"> <?= lang('monthly_salary') ?></input> &nbsp;&nbsp;&nbsp;
                    <input type="radio" name="type" value="Hourly" <?php if(!empty($empSalary)) echo $empSalary->type == 'Hourly'?'checked':''?> onclick="show_hourly();"> <?= lang('hourly_salary') ?></input>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label><?= lang('hourly_salary') ?> <span class="required">*</span></label>
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <?php if(count($salaryEarningList)): foreach($salaryEarningList as $earning):?>
                        ...
                        ?>
                        <div class="row">
                            <div class="col-sm-6"><?php echo $earning->component_name ?><strong>(<?php echo $earning->value_type ==1 ? lang('amount'): lang('percentage') ?>)</strong></div>
                            <div class="col-sm-6">
                                <div class="form-group">
