                    ...
                    <div class="col-md-8 col-sm-12 col-xs-12 col-md-push-1">
                        <br/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group form-group-bottom">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control input-lg" id="datepicker" name="date_of_birth" data-date-format="yyyy/mm/dd">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control input-lg" name="marital_status">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="id_number" class="form-control input-lg">
                            </div>
                        ...
                        <button class="btn btn-primary" type="submit" value="Submit"><i class="fa fa-save"></i> <?= lang('save_employee') ?></button>
