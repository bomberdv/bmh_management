                    ...
                    <div class="box box-primary" data-collapsed="0">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="well well-lg">
                                    <h3><?= lang('hourly_salary_generate') ?></h3>
                                    <p><strong><?= lang('date') ?>:</strong> <?= $month ?></p>
                                    <p><strong><?= lang('salary') ?> <?= lang('date_range') ?>:</strong> <?= $date_range ?></p>
                                ...
                                <div class="panel_controls" id="payRoll">
                                    <?php echo form_open('admin/payroll/save_batch_employee_hourlyPayslip') ?>
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $this->localization->currencyFormat($item->hourly_salary) ?></td>
                                            <td><input type="text" class="form-control" name="total_hour[]" ></td>
