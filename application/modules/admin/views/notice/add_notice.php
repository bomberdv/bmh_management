                        ...
                        <div class="panel-body">
                            ...
                            <div class="panel_controls">
                                <div class="form-group margin">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="title" value="<?php if(!empty($notice)) echo $notice->title ?>" class="form-control input-lg"  >
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-3 col-sm-5">
                                        <button class="btn btn-primary" type="submit" value="Submit"><i class="fa fa-save"></i> <?= lang('save').' '.lang('notice') ?></button>
                                    </div>
                                </div>
                            </div>
                            <?php echo form_close() ?>
