                    ...
                    <div class="sign-in-wrap">
                        ...
                        <div class="form-body">
                            ...
                            <ul class="nav nav-tabs final-login">
                                ...
                                <li style="color: white"><a data-toggle="tab" href="#employeeLogin">Employee Login</a></li>
                            </ul>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="employeeLogin" class="tab-pane fade">
                                    <div class="innter-form">
                                        <?php echo form_open(site_url('auth/login'), $attr = array('class' => 'sa-innate-form')) ?>
