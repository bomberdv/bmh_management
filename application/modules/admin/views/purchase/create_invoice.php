                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group form-group-bottom">
                                                ...
                                                <input type="text" name="email" class="form-control input-lg" value="<?php echo $v_detail->email ?>" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control input-lg" type="text" name="bill_ref">
                                            </div>
                                        </div>
...
//                            ?>
                            ...
                            <button class="btn btn-primary" type="submit" value="Submit"><i class="fa fa-save"></i> <?= lang('create').' '.lang('create_invoice') ?></button>
