    ...
    <div class="row" id="custom-widget">
        ...
        <div class="col-sm-6 col-md-3">
            <a class="block block-rounded  block-link-hover2 text-center" >
                ...
                <div class="block-content block-content-full block-content-mini bg-danger text-white h4 font-w600"> <span class="h6 badge bg-white-op"><?php echo $paid->total_invoice ?></span> <?php  echo strtoupper(lang('lifetime_paid')) ?></div>
            </a>
        </div>
