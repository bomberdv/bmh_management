...
//        'project' => array(
//            'name'		=> $CI->lang->line('project_management'),
//            'url'		=> 'product',
//            'icon'		=> 'tab_unselected',
//            'children'  => array(
//                $CI->lang->line('new_project')	=> 'project/newProject',
//                $CI->lang->line('manage_project')	=> 'project/manageProject',
//            )
//        ),
        ...
        'employee' => array(
            ...
            'children'  => array(
                ...
                $CI->lang->line('reimbursement')	    => 'employee/reimbursement',
            )
        ),
        ...
        'payroll' => array(
            ...
            'children'  => array(
                ...
                $CI->lang->line('generate_payslip')		=> 'payroll/payslip',
