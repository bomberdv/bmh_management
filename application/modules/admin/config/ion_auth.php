...
$config['tables']['branch']  		 = 'admin_branch';
$config['tables']['users_branch']  	 = 'admin_users_branch';
 ...
 */
$config['site_title']                 = "eOffice";       // Site Title, example.com
$config['admin_email']                = "no-replay@hrm.codeslab.net"; // Admin Email, admin@example.com
$config['default_group']              = 'admin';             // Default group, use name
$config['default_branch']             = 'jakarta';             // Default group, use name
