        ...
        <a class="block block-rounded block-link-hover2 text-center" href="javascript:void(0)">
            <div class="block-content block-content-full bg-success">
                <div class="h2 font-w700 text-white"><span
                            class="h2 text-white-op"><?php echo $total_attendance ?> / <?php echo $total_working_days ?>
                </div>
                <div class="h6 text-white-op text-uppercase push-5-t"><?php echo date("M Y") ?></div>
            </div>
    ...
    <div class="col-sm-6 col-lg-4">
        <a class="block block-rounded block-link-hover2 text-center" href="javascript:void(0)">
            <div class="block-content block-content-full bg-warning">
                <div class="h2 font-w700 text-white"><span
                            class="h2 text-white-op"><?php echo $approved_leave ?>
                </div>
                <div class="h6 text-white-op text-uppercase push-5-t"><?php echo date("M Y") ?></div>
            </div>
            <div class="block-content block-content-full block-content-mini">
    ...
    <div class="col-sm-6 col-lg-4">
        <a class="block block-rounded block-link-hover2 text-center" href="javascript:void(0)">
            <div class="block-content block-content-full bg-danger">
                <div class="h2 font-w700 text-white"><span
                            class="h2 text-white-op"></span> <?php echo $award ?>
                </div>
